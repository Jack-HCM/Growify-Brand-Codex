    ...
    <SectionWrapper id="applications" label="06 — Brand Applications" title="In the wild."
      ...
      <div className="mb-16">
        ...
        <div className="card overflow-hidden">
          ...
          <div className="relative overflow-hidden" style={{ minHeight: 300, backgroundColor: "#212130" }}>
            {/* Decorative green accent element */}
            <div className="absolute top-0 right-0 w-64 h-64 rounded-full opacity-10" style={{ backgroundColor: "#72cc76", transform: "translate(30%, -30%)" }} />
            <div className="absolute bottom-0 left-0 w-48 h-48 rounded-full opacity-5" style={{ backgroundColor: "#72cc76", transform: "translate(-30%, 30%)" }} />
            <div className="relative p-8">
              <nav className="flex items-center justify-between mb-14">
                ...
                <div className="hidden sm:flex items-center gap-6 text-xs text-[#9ca3af]">
                  ...
                  <button className="px-4 py-2 rounded-lg bg-[#72cc76] text-[#212130] text-xs font-medium">Book a call</button>
                </div>
              </nav>
              <div className="max-w-xl">
                <span className="px-3 py-1 rounded-full bg-[#72cc76]/20 border border-[#72cc76]/40 text-[#72cc76] text-[10px] font-medium mb-6 inline-block">
                ...
                <div className="flex gap-3">
                  <button className="px-5 py-2.5 rounded-lg bg-[#72cc76] text-[#212130] text-sm font-medium">Get started →</button>
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <div className="aspect-square rounded-xl overflow-hidden relative flex flex-col justify-between p-5" style={{ backgroundColor: "#212130" }}>
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mb-3">
                <div className="w-5 h-5 rounded-full bg-[#72cc76]/40 flex items-center justify-center flex-shrink-0">
                  <span className="text-[6px] text-white font-medium">JC</span>
                </div>
                <div>
                  <p className="text-[7px] text-white leading-tight">Jane Cooper</p>
                  <p className="text-[6px] text-[#72cc76] leading-tight">Head of Growth at 3XD</p>
                </div>
              </div>
              <span className="inline-block px-2 py-0.5 rounded-full bg-[#72cc76]/20 border border-[#72cc76]/40 text-[#72cc76] text-[6px]">
                2× organic traffic
              </span>
            </div>
          </div>
          ...
          {/* 2 — Stat card (dark bg) */}
          <div className="aspect-square rounded-xl overflow-hidden relative flex flex-col justify-between p-5" style={{ backgroundColor: "#1A2335" }}>
            ...
            <div>
              ...
              <p className="text-[9px] text-[#d4f0d5] leading-snug mb-1">organic traffic growth.</p>
              <p className="text-[7px] text-[#72cc76]">{brand.url}</p>
            </div>
          </div>

          {/* 3 — Brand statement (green bg) */}
          <div className="aspect-square rounded-xl overflow-hidden relative flex flex-col justify-between p-5" style={{ backgroundColor: "#72cc76" }}>
            <img src={brand.logo.landscape.black} alt="Growify" style={{ width: 60, height: "auto", display: "block" }} />
            <div>
              <p className="font-heading text-sm font-medium text-[#212130] leading-tight mb-2">
                Marketing that ships.
              </p>
              <p className="text-[8px] text-[#212130]/70 leading-relaxed mb-3">
                Systems-driven growth for ambitious brands.
              </p>
              <p className="text-[7px] text-[#212130]/60">{brand.url}</p>
            </div>
          </div>
          ...
          <div className="aspect-square rounded-xl flex flex-col justify-between p-5 border border-[#e5e7eb]" style={{ backgroundColor: "#f9f9fa" }}>
            <img src={brand.logo.landscape.black} alt="Growify" style={{ width: 60, height: "auto", display: "block" }} />
            <div>
              <span className="inline-block px-2 py-0.5 rounded-full border border-[#72cc76]/40 bg-[#72cc76]/10 text-[#212130] text-[6px] mb-2">
                AI-native
              </span>
              <p className="font-heading text-xs font-medium text-[#212130] leading-tight mb-1">
      ...
      <div>
        ...
        <div className="card p-8 max-w-lg">
          <div className="border-l-2 border-[#72cc76] pl-4">
            <p className="font-heading text-base font-medium text-[#212130]">Name Surname</p>
        ...
        <p className="text-xs text-[#9ca3af] mt-3">Growth Green left border. No logo in signature unless explicitly requested.</p>
      </div>
    </SectionWrapper>
  );
}
