...
export default function Contact() {
  return (
    <SectionWrapper
      ...
      title="Questions?"
      description="For brand usage questions or asset requests, contact the Growify team or reach out to the creative team at Hive Creative Media."
    ...
    >
        ...
        <div>
          ...
          <div className="space-y-4 mb-12">
            {[
              ...
              "For licensing enquiries, contact the Growify Marketing team directly.",
            ].map((text) => (
      ...
      <div className="mt-20 pt-10 border-t border-[#e5e7eb] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <img src={brand.logo.landscape.black} alt="Growify Marketing" style={{ width: 120, height: "auto", display: "block" }} />
        </div>
